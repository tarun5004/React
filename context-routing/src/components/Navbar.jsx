...
const Navbar = () => {
  const { setThemes, themes } = useContext(ThemeMode)

  const getNavLinkClasses = ({ isActive }) =>
    `cursor-pointer rounded-full px-4 py-2 transition-all duration-300 hover:-translate-y-0.5 ${
      isActive
        ? 'bg-zinc-200 text-zinc-900 shadow-[0_8px_20px_rgba(0,0,0,0.08)] hover:bg-zinc-300 dark:bg-zinc-700 dark:text-zinc-200 dark:hover:bg-zinc-600 dark:hover:text-white dark:shadow-[0_8px_20px_rgba(0,0,0,0.35)]'
        : 'hover:bg-white hover:text-zinc-950 hover:shadow-[0_8px_20px_rgba(0,0,0,0.08)] dark:hover:bg-zinc-900 dark:hover:text-white dark:hover:shadow-[0_8px_20px_rgba(0,0,0,0.35)]'
    }`
